...
extra/chrome-web-store/assets/shortcuts-screenshot-01.png: extra/chrome-web-store/assets/shortcuts-screenshot-01.svg extra/chrome-web-store/assets/screenshot_2025-01-07_11-47-29.png
	inkscape $< -o $@ -w 1280 -h 800
...
extra/chrome-web-store/assets/shortcuts-screenshot-02.png: extra/chrome-web-store/assets/shortcuts-screenshot-02.svg extra/chrome-web-store/assets/screenshot_2025-01-07_11-51-16.png
	inkscape $< -o $@ -w 1280 -h 800
...
extra/chrome-web-store/assets/shortcuts-screenshot-03.png: extra/chrome-web-store/assets/shortcuts-screenshot-03.svg extra/chrome-web-store/assets/screenshot_2025-01-07_19-37-31.png
	inkscape $< -o $@ -w 1280 -h 800
...
extra/chrome-web-store/assets/shortcuts-marquee-promo-tile.png: extra/chrome-web-store/assets/shortcuts-marquee-promo-tile.svg
	inkscape $< -o $@ -w 1400 -h 560

extra/chrome-web-store/assets/shortcuts-screenshot-01.fr.png: extra/chrome-web-store/assets/shortcuts-screenshot-01.fr.svg extra/chrome-web-store/assets/screenshot_2025-03-26_10-46-39.png
	inkscape $< -o $@ -w 1280 -h 800
...
extra/chrome-web-store/assets/shortcuts-screenshot-02.fr.png: extra/chrome-web-store/assets/shortcuts-screenshot-02.fr.svg extra/chrome-web-store/assets/screenshot_2025-03-26_12-25-43.png
	inkscape $< -o $@ -w 1280 -h 800
...
extra/chrome-web-store/assets/shortcuts-screenshot-03.fr.png: extra/chrome-web-store/assets/shortcuts-screenshot-03.fr.svg extra/chrome-web-store/assets/screenshot_2025-03-26_12-43-35.png
	inkscape $< -o $@ -w 1280 -h 800
